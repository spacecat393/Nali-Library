...
public class RayMath
{
    ...
    {
        float target_yaw_radians = (float)Math.toRadians(target.rotationPitch);
        float target_pitch_radians = (float)Math.toRadians(target.rotationYaw);
        ...
        float player_yaw_radians = (float)Math.toRadians(player.rotationPitch);
        float player_pitch_radians = (float)Math.toRadians(player.rotationYaw);
    ...
    public static boolean targetsView(Entity player, AxisAlignedBB axisalignedbb)
    {
        ...
        Vec3d view_vec3d = calculateView(player.rotationYaw, player.rotationPitch);
        Vec3d start_vec3d = new Vec3d(player.posX, player.posY, player.posZ);
        view_vec3d = view_vec3d.scale(0.05D);
        Vec3d end_vec3d = start_vec3d.add(view_vec3d);
