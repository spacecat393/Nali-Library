...
public class SakuraDropRender
{
    ...
    public SakuraDropRender(int texture_buffer)
    {
...
//        this.s -= this.ms * TD;
        ...
        GL11.glTranslatef(this.x - 8, this.y - 8, this.z);
        ...
        RenderHelper.drawModalRectWithCustomSizedTexture(0, 0, 0, 0, 16, 16, 16, 16);
