...
//    OPENGL_FIXED_PIPE_FLOATBUFFER_1 = ByteBuffer.allocateDirect(16 << 2).order(ByteOrder.nativeOrder()).asFloatBuffer(),
    ...
    R_M_FRAMEBUFFER = -1, R_S_FRAMEBUFFER = -1, R_T_FRAMEBUFFER = -1, R_G_FRAMEBUFFER = -1, R_TG_FRAMEBUFFER = -1, R_MC_FRAMEBUFFER = -1, R_MC2_FRAMEBUFFER = -1,
    R_M_FRAMEBUFFER_TEXTURE = -1, R_S_FRAMEBUFFER_TEXTURE = -1, R_T_FRAMEBUFFER_TEXTURE = -1, R_G_FRAMEBUFFER_TEXTURE = -1, R_TG_FRAMEBUFFER_TEXTURE = -1, R_MC_FRAMEBUFFER_TEXTURE = -1, R_MC2_FRAMEBUFFER_TEXTURE = -1,
//    R_M_RENDERBUFFER = -1, R_S_RENDERBUFFER = -1, R_T_RENDERBUFFER = -1, R_G_RENDERBUFFER = -1, R_TG_RENDERBUFFER = -1,
    R_M_RENDERBUFFER_TEXTURE = -1, R_S_RENDERBUFFER_TEXTURE = -1, R_T_RENDERBUFFER_TEXTURE = -1, R_G_RENDERBUFFER_TEXTURE = -1, R_TG_RENDERBUFFER_TEXTURE = -1, R_MC_RENDERBUFFER_TEXTURE = -1, R_MC2_RENDERBUFFER_TEXTURE = -1,
    MAX_BONE,
//    SHADERS,
